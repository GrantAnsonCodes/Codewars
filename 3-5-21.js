...
const find = (array, element)=> //converted traditional function to arrow funtion
  array.includes(element) ? array.indexOf(element): 'Not found' // utilized ternary and includes() method
